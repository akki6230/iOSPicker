...
//  AKPicker
//
//  Created by Ankit Kumar on 10/25/20.
//  Copyright © 2020 Ankit Kumar. All rights reserved.
//
...
@objc open class AKPicker: NSObject {
    
    private static let sharedInstance = AKPicker()
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          dataArray:Array<String> = [],
                          selectedIndex: Int? = nil,
                          type: AKPickerType = .date,
                          style: RDatePickerStyle = .Wheel) -> AKPickerController? {
        
        
        if let cc = UIWindow.currentController {
            if AKPicker.sharedInstance.isPresented == false {
                AKPicker.sharedInstance.isPresented = true
                
                let vc = AKPickerController(title: title, cancelText: cancelText, doneText: doneText, datePickerMode: datePickerMode, selectedDate: selectedDate, minDate: minDate, maxDate: maxDate, dataArray: dataArray, selectedIndex: selectedIndex, type: type, style: style)
                ...
                vc.onWillDismiss = {
                    AKPicker.sharedInstance.isPresented = false
                }
...
class AKPickerController: UIViewController {
    ...
    var pickerType: AKPickerType = .date
...
extension AKPickerController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        if (pickerLabel == nil) {
            pickerLabel = UILabel()
            pickerLabel?.font = UIFont(name: "HelveticaNeue-Bold", size: 16)
